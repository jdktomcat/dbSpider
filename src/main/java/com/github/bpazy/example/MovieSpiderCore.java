 ...
 * 2016/12/6 16:14
 */
public class MovieSpiderCore extends SpiderCore<Movie> {
    public MovieSpiderCore(String target, QueueAndRedis queueAndRedis) {
        super(target, queueAndRedis);
    }

    @Override
    protected String relatedUrlSelect() {
        return "div#recommendations div dl dt a";
    }
